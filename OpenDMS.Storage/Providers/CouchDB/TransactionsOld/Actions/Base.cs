...
namespace OpenDMS.Storage.Providers.CouchDB.TransactionsOld.Actions
{
    ...
    {
        public delegate void CommitProgressDelegate(Base sender, int currentStage, int totalStages, int packetSize, decimal sendPercentComplete, decimal receivePercentComplete);
        ...
        public delegate void AccessDeniedDelegate(Base sender, AccessDeniedReasonEnum reason, string message);
        ...
        protected void TriggerOnProgress(int currentStage, int totalStages, int packetSize, decimal sendPercentComplete, decimal receivePercentComplete)
        {
            if (OnProgress != null) OnProgress(this, currentStage, totalStages, packetSize, sendPercentComplete, receivePercentComplete);
        }
        ...
        protected void TriggerOnAccessDenied(AccessDeniedReasonEnum reason, string message)
        {
            if (OnAccessDenied != null) OnAccessDenied(this, reason, message);
        }
        ...
        protected virtual void AccessDenied(Commands.Base sender, AccessDeniedReasonEnum reason, string message)
        {
            TriggerOnAccessDenied(reason, message);
        }
    }
}
