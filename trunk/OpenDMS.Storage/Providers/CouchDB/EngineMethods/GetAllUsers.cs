...
namespace OpenDMS.Storage.Providers.CouchDB.EngineMethods
{
    public class GetAllUsers : Base
    {
        ...
        protected override void GetGlobalPermissions_OnComplete(EngineRequest request, ICommandReply reply)
        {
            ...
            try
            {
                cmd = new Commands.GetView(UriBuilder.Build(request.Database, "users", "GetAll"));
            }
            ...
            try
            {
                if (_onActionChanged != null) _onActionChanged(request, EngineActionType.GettingUsers, true);
            }
            catch (System.Exception e)
            {
