...
namespace OpenDMS.Storage.Providers.CouchDB.Commands
{
    public class PutDatabaseReply : ReplyBase
    {
        ...
        public PutDatabaseReply(Http.Response response)
            : base(response)
        {
        }
        ...
        protected override void ParseResponse()
        {
            switch (_response.StatusLine.StatusCode)
            {
                ...
                case 412:
                    ...
                    break;
                default:
                    Logger.Storage.Error("PutDatabaseReply received an unknown response code: " + _response.StatusLine.StatusCode.ToString());
                    Ok = false;
