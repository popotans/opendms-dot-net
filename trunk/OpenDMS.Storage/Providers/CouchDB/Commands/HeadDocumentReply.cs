...
namespace OpenDMS.Storage.Providers.CouchDB.Commands
{
    public class HeadDocumentReply : ReplyBase
    {
        ...
        public HeadDocumentReply(Http.Response response)
            : base(response)
        {
        }
        ...
        protected override void ParseResponse()
        {
            switch (_response.StatusLine.StatusCode)
            {
                ...
                case 404:
                    ...
                    break;
                default:
                    Logger.Storage.Error("HeadDocumentReply received an unknown response code: " + _response.StatusLine.StatusCode.ToString());
                    Ok = false;
